...
상품 상세보기
전체화면을 1대2로 분리합니다,
왼쪽은 상품의 이미지 정보, 오른쪽은 상품의 정보 '장바구니'와' '구매하기' 버튼을 만듭니다. 
*/
...
function App({user}) {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((error)=>{
                console.log(error);
                alert('상품 저오를 불러 오는 중에 오류가 발생하였습니다.');
    ...
    const addToCart = async () => {
        ...
        try{
            ...
            // BackEnd 영억에서 CartProductDto 라는 클래스와 매치됩니다. 
            const parameters = {
                memberId: user.id,
                ...
                <Row className="g-0">
                    ...
                    <Col md={8}>
                        ...
                        <Card.Body>
                            ...
                            {/* 구매 수량 입력란*/}
                            {/* as={Row} 렌더링시 기본 값인 <div> 말고 Row로 렌더링하도록 해줍니다.*/}
